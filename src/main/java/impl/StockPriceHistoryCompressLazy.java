...
public class StockPriceHistoryCompressLazy implements StockPriceHistory, Serializable {
    ...
    public StockPriceHistoryCompressLazy(String s, Date startDate, Date endDate, EntityManager em) {
    ...
    protected void makeZippedPrices() throws IOException {
        ...
        ObjectOutputStream oos =
            new ObjectOutputStream(new BufferedOutputStream(zip));
    ...
    protected void unzipPrices() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream ois =
            new ObjectInputStream(new BufferedInputStream(zip));
    ...
    private void checkPrices() {
        if (prices == null) {
            try {
                ...
                throw new IllegalStateException("No saved prices", ex);
            }
        }
    }
}

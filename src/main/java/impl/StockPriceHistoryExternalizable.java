...
import api.StockPrice;
import api.StockPriceHistory;
...
public class StockPriceHistoryExternalizable implements StockPriceHistory, Externalizable {
    ...
    public StockPriceHistoryExternalizable() {}
    ...
    public void writeExternal(ObjectOutput oo) throws IOException {
        oo.writeObject(symbol);
        oo.writeObject(prices);
        oo.writeObject(firstDate);
        oo.writeObject(lastDate);
        oo.writeBoolean(needsCalc);
        oo.writeObject(highPrice);
        oo.writeObject(lowPrice);
        oo.writeObject(averagePrice);
        oo.writeObject(stdDev);
    }

    @Override
    public void readExternal(ObjectInput oi)
        throws IOException, ClassNotFoundException {
        symbol = (String) oi.readObject();
        prices = (SortedMap<Date, StockPrice>) oi.readObject();
        firstDate = (Date) oi.readObject();
        lastDate = (Date) oi.readObject();
        needsCalc = oi.readBoolean();
        highPrice = (BigDecimal) oi.readObject();
        lowPrice = (BigDecimal) oi.readObject();
        averagePrice = (BigDecimal) oi.readObject();
        stdDev = (BigDecimal) oi.readObject();
    }
}

...
public class StockPriceHistoryEager implements StockPriceHistory, Serializable {
    ...
    public StockPriceHistoryEager(String s, Date startDate,
    ...
    protected synchronized void process() {
        ...
        for (StockPrice sp : prices.values()) {
            ...
            if (closingPrice.compareTo(lowPrice) < 0 || lowPrice == BigDecimal.ZERO) {
